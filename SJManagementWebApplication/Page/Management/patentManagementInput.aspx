...
<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="patentManagementInput.aspx.cs" Inherits="SJManagementWebApplication.patentManagementInput" EnableEventValidation="false" SmartNavigation="true" %>
...
<asp:Content ID="cContent3" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <div id="dHeadermenu" class="dHeadermenu">
        <h1 id="h1MainTitle" class="h1Maintitle">특허 등록</h1>
                ...
                <asp:UpdatePanel ID="upUpdatePanel2" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        ...
                        <div class="dInputForm3">
                            <dx:ASPxLabel ID="lbNameLab" CssClass="lbColumn" runat="server" Font-Size="12px" Text="특허명"></dx:ASPxLabel>
                        ...
                        <%-- 종류(콤보박스) --%>
                        <div class="dInputForm3">
                            <dx:ASPxLabel ID="lbDivLab" CssClass="lbColumn" runat="server" Font-Size="12px" Text="종류"></dx:ASPxLabel>
                            <dx:ASPxComboBox ID="cbDivTxt" runat="server" AutoPostBack="false" ClientInstanceName="cbDivTxt" Font-Size="12px" ButtonStyle-Font-Size="12px" ListBoxStyle-Font-Size="12px" ItemStyle-Font-Size="12px" HelpTextStyle-Font-Size="12px" CssClass="tbInput" AllowNull="true" FocusedStyle-Border-BorderWidth="1px" FocusedStyle-Border-BorderColor="#0071bc" FocusedStyle-Border-BorderStyle="Solid">
                                <Items>
                                    <dx:ListEditItem Value="상표" Text="상표" />
                                    <dx:ListEditItem Value="디자인" Text="디자인" />
                                    <dx:ListEditItem Value="특허" Text="특허" />
                                </Items>
                        ...
                        <%-- 특허 번호(텍스트박스) --%>
                        <div class="dInputForm3">
                            <dx:ASPxLabel ID="lbNumTxtLab" CssClass="lbColumn" runat="server" Font-Size="12px" Text="특허 번호"></dx:ASPxLabel>
                        ...
                        <%-- 출원 번호(텍스트박스) --%>
                        <div class="dInputForm3">
                            <dx:ASPxLabel ID="lbAppnumLab" CssClass="lbColumn" runat="server" Font-Size="12px" Text="출원 번호"></dx:ASPxLabel>
            ...
            <div id="dInputline2">
                ...
                <asp:UpdatePanel ID="UpdatePanel1_1" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        <%-- 발명자(텍스트박스) --%>
                        <div class="dInputForm3">
                            <dx:ASPxLabel ID="lbInventorLab" CssClass="lbColumn" runat="server" Font-Size="9pt" Text="발명자"></dx:ASPxLabel>
                            <dx:ASPxTextBox ID="tbInventorTxt" MaxLength="9" AutoCompleteType="Disabled" CssClass="tbInput" runat="server" Text="" ClientInstanceName="tbInventorTxt" FocusedStyle-Border-BorderWidth="1px" FocusedStyle-Border-BorderColor="#0071bc" FocusedStyle-Border-BorderStyle="Solid">
                                <HelpTextSettings Position="Right"></HelpTextSettings>
                            </dx:ASPxTextBox>
                        </div>
                        <%-- 출원 일자(달력) --%>
                        <div class="dInputForm3">
                            <dx:ASPxLabel ID="lbFilldateLab" CssClass="lbColumn" runat="server" Font-Size="9pt" Text="출원 일자"></dx:ASPxLabel>
                            <dx:ASPxDateEdit ID="deFilldate" runat="server" ClientSideEvents-GotFocus="function(s,e) {s.ShowDropDown();}"  CssClass="tbInput" AutoPostBack="false" ClientInstanceName="deFilldate" FocusedStyle-Border-BorderWidth="1px" FocusedStyle-Border-BorderColor="#0071bc" FocusedStyle-Border-BorderStyle="Solid">
                                <DropDownButton Image-Url="~/Content/icon/icon_calendar.svg" Image-Height="13px" Image-Width="13px"></DropDownButton>
                        ...
                        <%-- 등록 일자(달력) --%>
                        <div class="dInputForm3">
                            <dx:ASPxLabel ID="lbRegdateLab" CssClass="lbColumn" runat="server" Font-Size="9pt" Text="등록 일자"></dx:ASPxLabel>
                            <dx:ASPxDateEdit ID="deRegdate" AutoPostBack="false" ClientSideEvents-GotFocus="function(s,e) {s.ShowDropDown();}" CssClass="tbInput" runat="server" ClientInstanceName="deRegdate" Font-Size="9pt" FocusedStyle-Border-BorderWidth="1px" FocusedStyle-Border-BorderColor="#0071bc" FocusedStyle-Border-BorderStyle="Solid">
                                <DropDownButton Image-Url="~/Content/icon/icon_calendar.svg" Image-Height="13px" Image-Width="13px"></DropDownButton>
                ...
                <%-- PDF파일 추가(파일업로드) --%>
                <div class="dInputForm3">
                    <dx:ASPxLabel ID="lbPdfLab" CssClass="lbColumn" ClientVisible="true" ClientInstanceName="lbPdfLab" runat="server" ClientIDMode="Static" Font-Size="9pt" Text="PDF파일"></dx:ASPxLabel>
